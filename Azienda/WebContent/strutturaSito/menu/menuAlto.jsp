	...
	<div id="nav">
		<div class="menu">
			<ul class="corner">
				...
				<li><a href="./GestioneReport?azione=visualizzaConsuntivi" <% if(request.getParameter("azione") != null && request.getParameter("azione").equals("visualizzaConsuntivi")){ out.print("id='on'");} %>>Report</a></li>
